...
class SignatureAddScreen extends StatefulWidget {
  const SignatureAddScreen({Key? key}) : super(key: key);

  @override
  State<SignatureAddScreen> createState() => _SignatureAddScreenState();
}

class _SignatureAddScreenState extends State<SignatureAddScreen> {
  File? _image;
  ...
  Widget build(BuildContext context) {
    var signatureProvider = Provider.of<AccountProvider>(context, listen: false);
                  ...
                  InkWell(
                    onTap: (){
                      ...
                      if( _nameController.text == '' || _image == null){
                        showToast('Select Signature/Enter Signature Name');
                      }
                      else if ( _nameController.text != '' && _image != null) {
                        print('sss');
                        const SnackBar(content: Text('Loading'));
                        signatureProvider.uploadSignature(
