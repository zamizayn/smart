...
import 'package:smart_station/screens/home_screen/popup_screens/header_add.dart';
                ...
                Positioned(
                 ...
                 // right: 20,
                  ...
                  child: SizedBox(
                    ...
                    // color: Colors.red,
                    child:
                    (account.headData.isNotEmpty)?
                    ListView.builder(

                      itemCount: account.headData.length,
                      itemBuilder: (context, index) {
                        //var client = http.Client();
                        var name = account.headData[index]['name'];
                        return Padding(
                          ...
                          child: Column(
                            children: [
                              Row(
                               ...
                               children: [
                                 Text(account.headData[index]['name'],style: const TextStyle(fontSize: 17,color: Colors.grey),),
                           account.headData[index]['default'] == false  ?
                           InkWell(
                             onTap:() {
                               showDialog<String>(
                                 context: context,
                                   ...
                                   actions: <Widget>[
                                     TextButton(
                                       onPressed: () {
                                         ...
                                         account.setDefaultHeader(
                                             account.headData[index]['id'], account.headData[index]['name'],context);
                             ...
                             : const Text('Primary' ,style: TextStyle(fontSize: 17,color: Colors.green))
                               ],
                              ),
                              ...
                              Row(
                                ...
                                children: [
                                  DottedBorder(
                                    ...
                                    strokeWidth: 2,
                                    color: account.headData[index]['default'] == true ? Colors.green : Colors.grey,
                                    child:
                                 InkWell(
                                   onTap:(){
                                     Navigator.push(
                                       context,
                                       MaterialPageRoute(
                                         builder: (context) => ImageView(imageUrl: account.headData[index]['image'],name:account.headData[index]['name'],ctx:context),
                                       ),
                                     );
                                   },
                                   child: Container(
                                     ...
                                     Padding(
                                       ...
                                       child:
                                       ClipRect( child: Image.network(account.headData[index]['image'],
                                  ...
                                  InkWell(
                                    onTap:() {
                                      (account.headData[index]['default'] == true)?
                                      ...
                                      showDialog<String>(
                                        ...
                                        builder: (BuildContext context) => AlertDialog(
                                          ...
                                          content: Container(
                                            ...
                                            padding: const EdgeInsets.all(0.0),
                                            child: const Text('Do you want to delete this header?'),
                                          ),
                                          actions: <Widget>[
                                            TextButton(
                                              onPressed: () {
                                                account.removeHeader(account.headData[index]['id'], context);
                                              },
                                              child: const Text(
                                                'YES',
                                                style: TextStyle(
