...
import 'package:smart_station/screens/home_screen/popup_screens/signature_add.dart';
...
class SignatureHome extends StatefulWidget {
  const SignatureHome({Key? key}) : super(key: key);
            ...
            Positioned(
              ...
              child: SizedBox(
                width: MediaQuery
                    ...
                    .width,
                child:
                (account.signData.isNotEmpty)?
                ListView.builder(

                  itemCount: account.signData.length,
                  itemBuilder: (context, index) {
                  var name=  account.signData[index]['name'];
                    return Padding(
                      ...
                      child: Column(
                        children: [
                          Row(
                            ...
                            children: [
                              Text(account.signData[index]['name'],
                                style: const TextStyle(
                                    fontSize: 17, color: Colors.grey),),
                              account.signData[index]['default'] == false ?
                              InkWell(
                                  onTap:() {
                                    showDialog<String>(
                                      context: context,
                                        ...
                                        actions: <Widget>[
                                          TextButton(
                                            onPressed: () {
                                              ...
                                              account.setDefaultSignature(
                                                  account.signData[index]['id'], account.signData[index]['name'],context);
                          ...
                          Row(
                            ...
                            children: [
                              DottedBorder(
                                ...
                                strokeWidth: 2,
                                color: account.signData[index]['default'] ==
                                    true
                                    ? Colors.green
                                    : Colors.grey,
                                child:
                                InkWell(
                                  onTap:(){
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => ImageView(imageUrl: account.signData[index]['image'],name:account.signData[index]['name'],ctx:context),
                                      ),
                                    );
                                  },
                                  child: Container(
                                    ...
                                    Padding(
                                      ...
                                      child:
                                      ClipRect( child: Image.network(account.signData[index]['image'],
                              ...
                              InkWell(
                                onTap:() {
                                  (account.signData[index]['default'] == true)?
                                  ...
                                  showDialog<String>(
                                    ...
                                    builder: (BuildContext context) => AlertDialog(
                                      ...
                                      content: Container(
                                        ...
                                        padding: const EdgeInsets.all(0.0),
                                        child: const Text('Do you want to delete this signature?'),
                                      ),
                                      actions: <Widget>[
                                        TextButton(
                                          onPressed: () {
                                            account.removeSignature(account.signData[index]['id'], context);
                                          },
                                          child: const Text(
                                            'YES',
                                            style: TextStyle(
