...
class StampAddScreen extends StatefulWidget {
  const StampAddScreen({Key? key}) : super(key: key);

  @override
  State<StampAddScreen> createState() => _StampAddScreenState();
}

class _StampAddScreenState extends State<StampAddScreen> {
  File? _image;
  ...
  Widget build(BuildContext context) {
    var stampProvider = Provider.of<AccountProvider>(context, listen: false);
                ...
                InkWell(
                  onTap: (){
                    ...
                    if( _nameController.text == '' || _image == null){
                      showToast('Select Stamp / Enter Stamp Name');
                    }
                    else if ( _nameController.text != '' && _image != null) {
                      print('sss');
                      //keyBoardFocus.unfocus();
                      const SnackBar(content: Text('Loading'));
                      stampProvider.uploadStamp(
