...
class EmailSendView extends StatefulWidget {
  String emailId;
  ...
  @override
  State<EmailSendView> createState() => _EmailSendViewState();
}

class _EmailSendViewState extends State<EmailSendView> {
  bool tomeButtonBool = false;
  bool undoPressed = false;
  @override
  Widget build(BuildContext context) {
    var auth = Provider.of<AuthProvider>(context, listen: false);
    return FutureBuilder<GetSentMailDetails>(
      future:
          get_sent_mail_details(auth.userId, auth.accessToken, widget.emailId),
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      DateFormat('MMM dd').format(
                                          snapshot.data!.data.sentDatetime),
                                      style: const TextStyle(
                                        color: Colors.black,
                                        fontSize: 15,
                                        fontWeight: FontWeight.bold,
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "Date: ${DateFormat('MMM dd, yyyy, h:mm a').format(snapshot.data!.data.sentDatetime)}",
                                      style: const TextStyle(
                                          fontSize: 20,
                                          fontWeight: FontWeight.w700),
                                    ),
