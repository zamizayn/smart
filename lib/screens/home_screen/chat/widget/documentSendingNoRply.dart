...
class DocumentSendingNoRplyScreen extends StatefulWidget {
  String fPath;
  String hPath;
  String recId;
  String fileType;
  ...
  @override
  State<DocumentSendingNoRplyScreen> createState() =>
      _DocumentSendingNoRplyScreenState();
}

class _DocumentSendingNoRplyScreenState
    extends State<DocumentSendingNoRplyScreen> {
  final IO.Socket _socket = IO.io(AppUrls.appSocketUrl,
      IO.OptionBuilder().setTransports(['websocket']).build());

  _connectSocket() {
    _socket.connect();
    _socket.onConnect((data) => print('Connection establishedDocument'));
    _socket.onConnectError((data) => print('Connect Error $data'));
    _socket.onDisconnect((data) => print('Socket.IO disconnetedDocument'));
  }
