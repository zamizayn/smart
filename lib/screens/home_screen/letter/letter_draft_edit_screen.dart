...
class LetterDraftEditScreen extends StatefulWidget {
  final to;
  final addressTo;
  final subject;
  final body;
  ...
  final stamp;
  final id;
  const LetterDraftEditScreen({Key? key, this.to,this.addressTo,this.subject,this.body, this.bcc,this.cc,
  this.header,this.footer,this.sign,this.stamp,this.id}) : super(key: key);

  @override
  State<LetterDraftEditScreen> createState() => _LetterDraftEditScreenState();
}

class _LetterDraftEditScreenState extends State<LetterDraftEditScreen> {
  ...
  void initState() {
    ...
    List bccList=emailList;
      ...
      if(widget.addressTo!=''){
        _addressToController.text=widget.addressTo;
      }
      if(widget.bcc.isNotEmpty || widget.cc.isNotEmpty){
        showBcc=true;
      }
      if(widget.bcc.isNotEmpty){
        _bccChipsList=widget.bcc;
      }
      if(widget.cc.isNotEmpty){
        _ccChipsList=widget.cc;
      }
                  ...
                  onPressed: (){
                    ...
                    _bccChipsList.isNotEmpty || _subjectController.text.isNotEmpty){
                          LetterProvider().draftLetter(_selectedChips.join(','),
                               ...
                               _bccChipsList.join(','), _subjectController.text,widget.id).then((value) {
                                      ...
                                      itemBuilder: (context, index) {
                                        if(account.headData.isEmpty){
                                          return const SizedBox(
                                            height: 200,
                                            child: Center(
                                              child: Text('No Header',style: TextStyle(fontSize:17 ),),
                                            ),
                                          );
                                        }
                                        else{
                                ...
                                itemBuilder: (context, index) {
                                  if(account.footData.isEmpty){
                                          return const SizedBox(
                                            height: 200,
                                            child: Center(
                                              child: Text('No Footer',style: TextStyle(fontSize:17 ),),
                                            ),
                                          );
                                        }
                                        else{
                                      ...
                                      child: ListView.builder(
                                        ...
                                        itemBuilder: (context, index) {
                                          ...
                                          return const SizedBox(
                                            height: 200,
                                            child: Center(
                                              child: Text('No Signature',style: TextStyle(fontSize:17 ),),
                                            ),
                                          );
                                        }
                                        else{
                                      ...
                                      child: ListView.builder(
                                        ...
                                        itemBuilder: (context, index) {
                                          ...
                                          return const SizedBox(
                                            height: 200,
                                            child: Center(
                                              child: Text('No Stamp',style: TextStyle(fontSize:17 ),),
                                            ),
                                          );
                                        }
                                        else{
  ...
  void _sendMail(contexts) {
    ...
    if(_selectedChips.isEmpty){
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context)=>PreviewScreen(
        ...
        sent:_selectedChips.join(',') ,cc: _ccChipsList.join(','),bcc: _bccChipsList.join(','),sign: Signature ,stamp: Stamp,header: Header,footer: Footer ,id: widget.id,)));
    }
