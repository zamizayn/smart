...
class LetterStarredScreen extends StatefulWidget {
  const LetterStarredScreen({Key? key}) : super(key: key);

  @override
  State<LetterStarredScreen> createState() => _LetterStarredScreenState();
}

class _LetterStarredScreenState extends State<LetterStarredScreen> {
  @override
 // var letter;
  ...
  List tempDraft = [];
    @override
  void initState() {
      selectedStarredLetter.clear();
    // TODO: implement initState
    print('fd');
    super.initState();
    setState(() {
    //  letter = Provider.of<LetterProvider>(context,listen: false);
    // letter.getStarredList(context);
    // print(letter.starredData.length);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: selectedStarredLetter.isNotEmpty || selectedDraftLetter.isNotEmpty?AppBar(
              backgroundColor: Colors.grey[500],
               leading: IconButton(
                  ...
                  title: Text('${selectedStarredLetter.length+selectedDraftLetter.length} selected'),
              actions: [
                IconButton(
                  onPressed: (){
                   // deletePressed= true;
                   if(archiveStatus.contains('1')){
                    setState(() {
                      print('assign to temp');
                    
                        tempDelete= List.from(selectedDate);
                        selectedDate.clear();
                        tempSelected = List.from(selectedStarredLetter);
                        selectedStarredLetter.clear();
                ...
                icon: Icon(
                    archiveStatus.contains('1')?  Icons.archive:Icons.unarchive,
                      color: Colors.white,
                      size: 30,
                    )),
                     IconButton(
    ...
    child: Container(
      ...
      body:Center(
              ...
              FutureBuilder(
                future: LetterProvider().getStarredList(context),
                builder: (context, snapshot) {
                  ...
                  if(snapshot.hasData){
                    ...
                    return const Center(
                      child: Text('No starred letter',style: TextStyle(fontSize: 16),),
                    );
                  }
                  else{
                  ...
                  itemBuilder: (context, index) {
                    print(snapshot.data['letter_list'][index]['mail_read_status']);
                    ...
                    // else{
                      ...
                      // else{
                         ...
                         onLongPress: () {
                            ...
                            print(selectedStarredLetter);
                            if((selectedStarredLetter.contains(snapshot.data['letter_list'][index]['id'].toString())
                            &&snapshot.data['letter_list'][index]['type']=='letter') ||
                            ...
                            setState(() {
                              ...
                              selectedStarredLetter.remove(snapshot.data['letter_list'][index]['id'].toString());
                              }
                              ...
                              archiveStatus.remove(snapshot.data['letter_list'][index]['archive_status'].toString());
                            ...
                            setState(() {
                              ...
                              selectedStarredLetter.add(snapshot.data['letter_list'][index]['id'].toString());
                              }
                              ...
                              archiveStatus.add(snapshot.data['letter_list'][index]['archive_status'].toString());
                          ...
                          child: Container(
                             decoration: BoxDecoration(borderRadius: BorderRadius.circular(15),
                                    color:(selectedStarredLetter.contains(snapshot.data['letter_list'][index]['id']) &&
                                    snapshot.data['letter_list'][index]['type']=='letter')
