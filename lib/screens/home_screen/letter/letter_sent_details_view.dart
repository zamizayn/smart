...
class LetterSentDetailView extends StatefulWidget {
  final Email email;
  const LetterSentDetailView({super.key, required this.email});

  @override
  State<LetterSentDetailView> createState() => _LetterSentDetailViewState();
}

class _LetterSentDetailViewState extends State<LetterSentDetailView> {
                                ...
                                children: [
                                  Text(
                                    ...
                                    Container(
                                      ...
                                      color: widget.email.color),
                                      child: Center(child: Text(widget.email.approve_status)),
                                    )
